  ...
  return (
    <nav className="w-full bg-gray-900/90 dark:bg-gray-900/90 bg-white/90 border-b border-gray-800 dark:border-gray-800 border-gray-200 px-6 py-3 flex items-center justify-between backdrop-blur-md navbar-glow">
      ...
      <div className="flex items-center gap-4 text-sm">
        ...
        {/* Sign In */}
        <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-800 transition-all">
